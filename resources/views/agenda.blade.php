            ...
            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-sm-12 post-content">
                                    <div class="post-title">
                                        <h3>
                                            <a title="" href="http://esc-embrio.ipb.ac.id">4Th Embrio International Workshop
                                            </a>
                                        </h3>
                                        <p class="post-meta">
                        ...
                        <article class="post">
                            <div class="row">
                                ...
                                <div class="col-md-12 col-sm-12 post-content">
                                    <div class="post-title">
                                        <h3>
                                            <a title="" href="#">Munas dan Ruaya FPIK IPB</a>
                                        </h3>
                                        <p class="post-meta">
                                            <!-- <a href="../arsip/liputan-berita.html" class="post-category">Liputan/Berita</a> -->
                                            <span class="post-date">12 sep 2020</span>
                                        </p>
                                    </div>
                                    <div class="entry-content">
                        ...
                        <article class="post">
                            <div class="row">
                                ...
                                <div class="col-md-12 col-sm-12 post-content">
                                    <div class="post-title">
                                        <h3>
                                            <a title="" href="https://ESC-embrio.ipb.ac.id">M5th EMBRIO International Summer Course (EISC)</a>
                                        </h3>
                                        <p class="post-meta">
                                            <!-- <a href="../arsip/liputan-berita.html" class="post-category">Liputan/Berita</a> -->
                                            <span class="post-date">14 sep 2020 - 5 okt 2020</span>
                                        </p>
                                    </div>
                ...
                <div id="sidebar" class="col-md-3">
                    <div class="widget widget_recent_entries">
                        ...
                        <ul class="post-list">
                            <li>
                                <a href="berita-1.html" title="Riset dosen IPB terkait sidat masuk prioritas riset nasional">Riset dosen IPB
                                    terkait sidat masuk prioritas riset nasionala</a>
