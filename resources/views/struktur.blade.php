...
<head>
    ...
    <title>Struktur Fakultas Perikanan dan kelautan IPB</title>
    <meta charset="UTF-8">
                ...
                <div id="content" class="col-md-8 col-md-push-1 sidebar-right">
                    ...
                    <article class="single-post">
                        ...
                        <div class="post-content">
                            <p>
                                <a title="Struktur Organisasi Fakultas Perikanan IPB University" href="{{asset('frontend/photo/struktur/STRUKTUR+ORGANISASI+FPIK+-1.png')}}">
                                    <img src="{{asset('frontend/photo/struktur/STRUKTUR+ORGANISASI+FPIK+-1.png')}}" alt="" width="700" height="200" />
                                </a>
                            </p>
                        </div>
                    </article>
